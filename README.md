...
|                                                                                            deleteMessages(string $object_guid, array                                                                                             |                                  int $message_id, DeleteType $type = DeleteType::Local)                                   |            delete message in guid ---->  DeleteType = {Global, Local}             | [deleteMessages.json](examples/deleteMessages.json) |
